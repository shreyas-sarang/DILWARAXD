// -------------------------------------------------------------
// 
// File Name: A:\internship\MATLAB\MUL\MUL\MUL_tb.v
// Created: 2022-12-13 22:11:57
// 
...
module MUL_tb;
  ...
  // holdData reg for A_out1
  always @(posedge clk or posedge reset)
    begin : stimuli_A_out1
      if (reset) begin
        holdData_A <= 8'bx;
      end
      else begin
  ...
  // holdData reg for B_out1
  always @(posedge clk or posedge reset)
    begin : stimuli_B_out1
      if (reset) begin
        holdData_B <= 8'bx;
      end
      else begin
  ...
  MUL u_MUL (.A(A_1),  // uint8
             .B(B_1),  // uint8
             .Y(Y)  // uint8
             );

  // Data source for Y_expected
  assign Y_expected_1 = 8'b00000001;
